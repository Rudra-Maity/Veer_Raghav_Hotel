...
const Navbar = () => {
    ...
    const dropdownItemStyle = "px-4 py-2 text-left text-[#FF9933] hover:bg-[#FF9933] hover:text-white transition duration-200 block";
                            ...
                            >
                                ...
                                {showDropdown.rooms && (
                                    <motion.div 
                                        ...
                                        className="absolute bg-white mt-2 drop-shadow-lg rounded-lg"
                                    >
                            ...
                            >
                                ...
                                {showDropdown.pages && (
                                    <motion.div 
                                        ...
                                        exit={{ opacity: 0, y: -20 }}
                                        transition={{ duration: 0.3 }}
                                        className="absolute bg-white left-0 mt-2 drop-shadow-lg rounded-lg"
                                    >
                                        <div className="py-2 w-max">
                    ...
                    <div className='relative'>
                        ...
                        {showDropdown.rooms && (
                            <motion.div 
                                ...
                                exit={{ opacity: 0, y: -20 }}
                                transition={{ duration: 0.3 }}
                                className="py-2 bg-white shadow-md"
                            >
                                <Link href={'/deluxe-rooms'} className={dropdownItemStyle}>Deluxe Rooms</Link>
                                <Link href={'/standard-rooms'} className={dropdownItemStyle}>Standard Rooms</Link>
                                <Link href={'/suites'} className={dropdownItemStyle}>Suites</Link>
